          ...
          <div className="order-1 lg:order-2">
            <div className="text-center lg:text-left">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
                Healthcare Made
                <br />
                <span className="text-cyan-600">Effortless</span>
              </h2>
              
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-10 leading-relaxed">
                Join our platform and experience the future of medical consultations
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 bg-white dark:bg-neutral-900 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-neutral-800">
                  <div className="p-3 bg-cyan-100 dark:bg-cyan-900/30 rounded-xl flex-shrink-0">
                    <IconSparkles className="w-6 h-6 text-cyan-600 dark:text-cyan-400" />
                  </div>
                  <div className="text-left">
                    <h3 className="font-bold text-gray-900 dark:text-white mb-1">No Credit Card Required</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Start with our free plan and upgrade anytime</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-white dark:bg-neutral-900 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-neutral-800">
                  ...
                  <div className="text-left">
                    <h3 className="font-bold text-gray-900 dark:text-white mb-1">Expert AI Doctors</h3>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Trained on millions of medical cases</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 bg-white dark:bg-neutral-900 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-neutral-800">
                  ...
                  <div className="text-left">
                    <h3 className="font-bold text-gray-900 dark:text-white mb-1">HIPAA Compliant</h3>
